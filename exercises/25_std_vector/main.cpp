...
int main(int argc, char **argv) {
    {
        ...
        // THINK: `std::vector` 的大小是什么意思？与什么有关？ // std::vector<int>在内存中占用的字节数，64位系统中通常为24字节。指针（8 字节） + 元素数量（8 字节） + 容量（8 字节）
    ...
    }
    {
        ...
        {
            // THINK: `std::vector` 插入删除的时间复杂度是什么？ // O(1)
    ...
    }
    {
        ...
        ASSERT(sizeof(vec) == 24, "Fill in the correct value.");
        {
            // 未使用 auto capacity = vec.capacity();
            vec.resize(16);
